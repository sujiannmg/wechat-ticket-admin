...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <ol class="breadcrumb" style="margin-bottom: 0px">
      ...
      <li><a href="${webContextPath!}/wechatuserinfoadmin"><i class="fa fa-wechat"></i> 微信用户信息管理</a></li>
      <li class="active"><i class="fa fa-list-alt"></i> 微信用户信息详情</li>
    </ol>
    <!-- Main content -->
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">详细微信用户信息</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <#if error ?? >
              ...
              <form id="accountEditForm" method="POST" action="${webContextPath!}/wechatuserinfoadmin/edit/" class="form-horizontal dss-base-form">
                ...
                <div class="hr-line-dashed"></div>
                <div class="form-group"><label class="col-sm-2 control-label">用户性别</label>
                  <div class="col-sm-8">
                    <label class="form-control"> <#if wechatUserInfo ??> ${wechatUserInfo.getGender()!}</#if> </label>
                  </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group"><label class="col-sm-2 control-label">用户城市</label>
                  <div class="col-sm-8">
                    <label class="form-control"> <#if wechatUserInfo ??> ${wechatUserInfo.getCity()!}</#if> </label>
                  </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group"><label class="col-sm-2 control-label">用户省会</label>
                  <div class="col-sm-8">
                    <label class="form-control"> <#if wechatUserInfo ??> ${wechatUserInfo.getProvince()!}</#if> </label>
                  </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group"><label class="col-sm-2 control-label">头像路径</label>
                  <div class="col-sm-8">
                    <#if wechatUserInfo ??> ${wechatUserInfo.getAvatarUrl()!}</#if>
                  </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group"><label class="col-sm-2 control-label">统一标识</label>
                  <div class="col-sm-8">
